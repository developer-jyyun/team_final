        ...
        <div className="py-3 ml-3">
          ...
          <div className="mt-4 mx-4">
            <div className="flex ml-2 mb-4">
              <Image src={imageSrc} alt="체크전이미지" width={24} height={24} />
            ...
            >
              ...
              <p className="text-black-6 text-xs font-bold">1.제1조 (목적)</p>
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ...
                여행자에게 제공될 운송 및 숙식서비스 내용(이하 ‘여행서비스’라
                함), 여행요금을 정하여 광고 또는 기타 방법으로 여행자를 모집하여
                실시하는 여행.
                <br /> 2. 희망여행 : 여행자(개인 또는 단체)가 희망하는
                여행조건에 따라 당사가 운송ㆍ숙식ㆍ관광 등 여행에 관한 전반적인
                계획을 수립하여 실시하는 여행.
                <br /> 3. 해외여행 수속대행(이하 ‘수속대행계약’이라 함) : 당사가
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ① 당사는 여행자에게 안전하고 만족스러운 여행서비스를 제공하기
                위하여 여행알선 및 안내ㆍ운송ㆍ숙박 등 여행계획의 수립 및
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ① 여행계약은 여행계약서(붙임)와 여행약관ㆍ여행일정표(또는 여행
                설명서)를 계약내용으로 합니다.
                <br /> ② 여행계약서에는 당사의 상호, 소재지 및 관광진흥법
                제9조에 따른 보증보험 등의 가입(또는 영업보증금의 예치 현황)
                내용이 포함되어야 합니다.
                <br /> ③ 여행일정표(또는 여행설명서)에는 여행일자별 여행지와
                관광내용ㆍ교통수단ㆍ쇼핑횟수ㆍ숙박장소ㆍ식사 등 여행실시일정 및
                당사 제공 서비스 내용과 여행자 유의사항이 포함되어야 합니다.
              </p>
              <p className="text-black-6 text-xs font-bold">
                5.제5조 (계약체결의 거절)
              </p>
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                당사는 여행자에게 다음 각 호의 1에 해당하는 사유가 있을 경우에는
              ...
              <p className="text-black-6 text-xs font-bold">6.제6조 (특약)</p>
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ...
                여행목적지에 관한 안전정보를 제공하여야 합니다. 또한 여행 출발
                전 해당 여행지에 대한 안전정보가 변경된 경우에도 변경된
                안전정보를 제공하여야 합니다.
              </p>
              <p className="text-black-6 text-xs font-bold">
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ...
                <br /> 1. 여행자가 인터넷 등 전자정보망으로 제공된 여행계약서,
                약관 및 여행일정표(또는 여행설명서)의 내용에 동의하고 여행계약의
                체결을 신청한 데 대해 당사가 전자정보망 내지 기계적 장치 등을
                이용하여 여행자에게 승낙의 의사를 통지한 경우 <br />
                2. 당사가 팩시밀리 등 기계적 장치를 이용하여 제공한 여행계약서,
                약관 및 여행일정표(또는 여행설명서)의 내용에 대하여 여행자가
                동의하고 여행계약의 체결을 신청하는 서면을 송부한 데 대해 당사가
                전자정보망 내지 기계적 장치 등을 이용하여 여행자에게 승낙의
                의사를 통지한 경우
              </p>
              <p className="text-black-6 text-xs font-bold">
                9.제9조 (당사의 책임)
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ...
                제3조제1항에서 규정한 당사 임무와 관련하여 여행자에게 고의 또는
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                ...
                당사는 그 사유를 안내하여야 합니다. <br />③ 여행자는 계약체결시
                계약금(여행요금 중 10%이하 금액)을 당사에게 지급하여야 하며,
                계약금은 여행요금 또는 손해배상액의 전부 또는 일부로 취급합니다.
                <br />④ 여행자는 제1항의 여행요금 중 계약금을 제외한 잔금을
                여행출발 7일전까지 당사에게 지급하여야 합니다. <br />⑤ 여행자는
                제1항의 여행요금을 당사자가 약정한 바에 따라 카드, 계좌이체 또는
                무통장입금 등의 방법으로 지급하여야 합니다. <br />⑥
                희망여행요금에 여행자 보험료가 포함되는 경우 당사는 보험회사명,
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-1">
                ① 국외여행을 실시함에 있어서 이용운송ㆍ숙박기관에 지급하여야 할
                요금이 계약체결시보다 5%이상 증감하거나 여행요금에 적용된
                외화환율이 계약체결시보다 2% 이상 증감한 경우 당사 또는 여행자는
                그 증감된 금액 범위 내에서 여행요금의 증감을 상대방에게 청구할
                수 있습니다. <br />② 당사는 제1항의 규정에 따라 여행요금을
                증액하였을 때에는 여행출발일 15일전에 여행자에게 통지하여야
                합니다.
              </p>
            ...
            >
              ...
              <ul className="text-black-7 text-xs font-normal">
                <li>
                  • 소유자 명, 카드 번호, 할부 개월, 유효 기간, 카드 비밀번호 앞
                  2자리
                </li>
              </ul>
              <p className="text-black-6 text-xs font-bold mt-4 mb-2">
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-1">
                ...
                목적으로 60일간 별도 보관됩니다.
                <br />
                <br />※ 동의를 거부할 권리 및 동의 거부에 따른 불이익 정보주체는
                개인정보 수집 및 이용에 대해 거부할 권리가 있습니다.동의를
                거부할 경우 상품 예약과 관련한 정보의 수집 및 이용이 이루어지지
                않으므로 서비스 제공이 불가함을 알려 드립니다.
              </p>
              <div ref={bottomScrollRef}>
                <BottomScroll />
              </div>
            ...
            >
              ...
              <p className="text-black-7 text-xs font-normal leading-normal mb-2">
                ...
                위하여 고객으로부터 최소한의 필수정보를 수집하며, 제공한 모든
                개인정보는 별도의 동의가 없는 한 해당 목적 이외의 다른 목적으로
                사용하지 않습니다.
                <br />
                <br /> 고객님은 개인정보 수집 및 이용에 대한 동의를 거부할
                권리가 있습니다. 동의를 거부할 경우 여행상품 예약 서비스 이용이
                불가함을 알려드립니다.
              </p>
              <p className="text-black-6 text-xs font-bold mt-4 mb-2">
                1.서비스영역 : 항공 / 해운 / 철도
              ...
              <ul className="text-black-7 text-xs font-normal leading-normal mb-2">
                <li>- 제공받는 자</li>
                <li>
                  • 대한항공, 아시아나 항공 및 국내외 항공사, 철도업체(코레일),
                  해운업체(페리,크루즈)
                </li>
                <li>- 제공목적</li>
                <li>
                ...
                <li>
                  ...
                  여권정보(영문명, 여권번호, 여권만료일), 항공사, 마일리지 정보,
                  카드정보
                </li>
              </ul>
              <p className="text-black-6 text-xs font-bold mt-4 mb-2">
              ...
              <ul className="text-black-7 text-xs font-normal leading-normal mb-2">
                ...
                <li>- 제공목적</li>
                <li>
                  • 투어/입장권/공연 예매, 상품배송 구매자 식별/취소/환불 등의
                  업무처리
                </li>
                <li>- 제공항목</li>
                <li>• 성명, 휴대폰번호</li>
