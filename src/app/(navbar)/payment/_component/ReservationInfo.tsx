...
const ReservationInfo = ({ onComplete }: Props) => {
  ...
  const [showCollectingPersonalInfo, setShowCollectingPersonalInfo] =
    useState(false);
  const [showUniqueIdentificationInfo, setShowUniqueIdentificationInfo] =
    useState(false);
  const [showOfThirdPartyConsent, setShowOfThirdPartyConsent] = useState(false);
  ...
  const toggleCollectingPersonalInfo = () => {
    setShowCollectingPersonalInfo(!showCollectingPersonalInfo);
  };

  const toggleUniqueIdentificationInfo = () => {
    setShowUniqueIdentificationInfo(!showUniqueIdentificationInfo);
  };

  const toggleOfThirdPartyConsent = () => {
    setShowOfThirdPartyConsent(!showOfThirdPartyConsent);
  };
        ...
        <div className="py-3 ml-3">
          ...
          <div className="mt-4 mx-4">
            ...
            {showCancellationPolicy && (
              <div className="h-52 bg-grey-transparent rounded-lg p-3.5 overflow-scroll">
                ...
                <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                  ...
                  함), 여행요금을 정하여 광고 또는 기타 방법으로 여행자를
                  모집하여 실시하는 여행.
                ...
                <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                  ...
                  약관 및 여행일정표(또는 여행설명서)의 내용에 동의하고
                  여행계약의 체결을 신청한 데 대해 당사가 전자정보망 내지 기계적
                  장치 등을 이용하여 여행자에게 승낙의 의사를 통지한 경우 <br />
                ...
                <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                  ...
                  당사는 그 사유를 안내하여야 합니다. <br />③ 여행자는
                  계약체결시 계약금(여행요금 중 10%이하 금액)을 당사에게
                  지급하여야 하며, 계약금은 여행요금 또는 손해배상액의 전부 또는
                  일부로 취급합니다.
            ...
            <div
              className="flex bg-pink-transparent-2 p-2 my-2 rounded-lg relative"
              onClick={toggleCollectingPersonalInfo}
            >
              <Image
                src="/icons/checkIcon2.svg"
                alt="체크전이미지"
            ...
            {showCollectingPersonalInfo && (
              <div className="h-52 bg-grey-transparent rounded-lg p-3.5 overflow-scroll">
                ...
                <ul className="text-black-7 text-xs font-normal">
                  <li>
                    • 소유자 명, 카드 번호, 할부 개월, 유효 기간, 카드 비밀번호
                    앞 2자리
                  </li>
                </ul>
                <p className="text-black-6 text-xs font-bold mt-4 mb-2">
                ...
                <p className="text-black-7 text-xs font-normal leading-normal mb-3">
                  ...
                  있습니다.동의를 거부할 경우 상품 예약과 관련한 정보의 수집 및
                  이용이 이루어지지 않으므로 서비스 제공이 불가함을 알려
                  드립니다.
                </p>
              </div>
            )}
            <div
              className="flex bg-pink-transparent-2 p-2 my-2 rounded-lg relative"
              onClick={toggleUniqueIdentificationInfo}
            >
              <Image
                src="/icons/checkIcon2.svg"
                alt="체크전이미지"
            ...
            <div
              className="flex bg-pink-transparent-2 p-2 my-2 rounded-lg relative"
              onClick={toggleOfThirdPartyConsent}
            >
              <Image
                src="/icons/checkIcon2.svg"
                alt="체크전이미지"
            ...
            {showOfThirdPartyConsent && (
              <div className="h-52 bg-grey-transparent rounded-lg p-3.5 overflow-scroll">
                ...
                <p className="text-black-7 text-xs font-normal leading-normal mb-2">
                  ...
                  개인정보는 별도의 동의가 없는 한 해당 목적 이외의 다른
                  목적으로 사용하지 않습니다.
                  <br />
